...
export default ({ ...props }: CustomProps) => {
  return (
    ...
    >
      ...
      <defs>
        <circle id="prefix__A" cx={96} cy={96} r={88} />
        <path id="prefix__B" d="M8 184h83.77l38.88-38.88V116h-69.3L8 24.48z" />
      </defs>
      <clipPath id="prefix__C">
        <use xlinkHref="#prefix__A" />
      </clipPath>
      <g className="prefix__B" transform="translate(-7 -7)">
        ...
        >
          <stop stopColor="#a52714" stopOpacity={0.6} offset={0} />
          <stop stopColor="#a52714" stopOpacity={0} offset={0.66} />
        </linearGradient>
        <path d="M21.97 8v108h39.4L96 56h88V8z" fill="url(#prefix__D)" />
        <path
          d="M62.3 115.6L22.48 47.3l-.58 1 39.54 67.8z"
          className="prefix__C prefix__D"
        />
        <use xlinkHref="#prefix__B" fill="#0f9d58" />
        <linearGradient
          id="prefix__E"
          x1={110.9}
          x2={52.54}
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#055524" stopOpacity={0.4} offset={0} />
          <stop stopColor="#055524" stopOpacity={0} offset={0.33} />
        </linearGradient>
        <path
        ...
        <g clipPath="url(#prefix__G)">
          ...
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor="#ea6100" stopOpacity={0.3} offset={0} />
            <stop stopColor="#ea6100" stopOpacity={0} offset={0.66} />
          </linearGradient>
          <path d="M96 56l34.65 60-38.88 68H184V56z" fill="url(#prefix__H)" />
        </g>
        <path d="M96 56l34.65 60-38.88 68H184V56z" fill="#ffcd40" />
        <path d="M96 56l34.65 60-38.88 68H184V56z" fill="url(#prefix__H)" />
        <defs>
          <path id="prefix__I" d="M96 56l34.65 60-38.88 68H184V56z" />
        </defs>
      ...
      <radialGradient
        ...
        gradientUnits="userSpaceOnUse"
      >
        <stop stopColor="#3e2723" stopOpacity={0.2} offset={0} />
      ...
      <g className="prefix__B" transform="translate(-7 -7)">
        <defs>
          <path id="prefix__L" d="M21.97 8v40.34L61.36 116 96 56h88V8z" />
        </defs>
